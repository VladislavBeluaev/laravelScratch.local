...
@section('content')
    ...
    <form class="text-center border border-light p-5" action="{{route('create_projects')}}" method="POST">
        {{csrf_field()}}
        <input type="text" name="title" id="defaultRegisterFormEmail" class="form-control mb-4" placeholder="Project title">
